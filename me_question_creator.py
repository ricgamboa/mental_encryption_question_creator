...
def main():
    ...
    current_question = me_components_save.Question(current_id, num_answer_letters)
    ...
    for count_pos in range(current_question.num_answer_letters):
        position = me_components_save.PositionList(POSITION_LIST_SIZE, NUM_ICONS_SENDER)
